...
const FALLBACK_CARS: CarType[] = [
  { id: 1, name: "VW Golf", brand: "Volkswagen", model: "Golf", category: "economy", pricePerDay: 35, seats: 5, transmission: "manual", fuelType: "petrol", imageUrl: "/images/cars/vw-golf.jpg", available: true, features: ["Klimë", "Bluetooth", "GPS"], rating: 4.7, reviewCount: 124 },
  { id: 2, name: "Toyota Yaris", brand: "Toyota", model: "Yaris GR", category: "economy", pricePerDay: 40, seats: 5, transmission: "automatic", fuelType: "petrol", imageUrl: "/images/cars/toyota-yaris.jpg", available: true, features: ["Klimë", "Kamera Prapa", "Bluetooth"], rating: 4.8, reviewCount: 98 },
  { id: 3, name: "BMW 3 Series", brand: "BMW", model: "330i", category: "standard", pricePerDay: 75, seats: 5, transmission: "automatic", fuelType: "petrol", imageUrl: "/images/cars/bmw-3series.jpg", available: true, features: ["Ulëse të Ngrohta", "GPS", "Bluetooth", "Klimë"], rating: 4.9, reviewCount: 201 },
  { id: 4, name: "Mercedes C-Class", brand: "Mercedes", model: "C 300", category: "standard", pricePerDay: 90, seats: 5, transmission: "automatic", fuelType: "petrol", imageUrl: "/images/cars/mercedes-c.jpg", available: true, features: ["Ulëse të Ngrohta", "GPS", "Panorama", "Klimë"], rating: 4.9, reviewCount: 187 },
  { id: 5, name: "BMW X5", brand: "BMW", model: "X5 40i", category: "suv", pricePerDay: 120, seats: 7, transmission: "automatic", fuelType: "petrol", imageUrl: "/images/cars/bmw-x5.jpg", available: true, features: ["7 Vende", "GPS", "Panorama", "Klimë 4-zonë"], rating: 4.8, reviewCount: 156 },
  { id: 6, name: "Porsche Cayenne", brand: "Porsche", model: "Cayenne S", category: "suv", pricePerDay: 180, seats: 5, transmission: "automatic", fuelType: "petrol", imageUrl: "/images/cars/porsche-cayenne.jpg", available: true, features: ["Sport Mode", "GPS", "Panorama", "Ulëse Masazh"], rating: 5.0, reviewCount: 89 },
  { id: 7, name: "Mercedes S-Class", brand: "Mercedes", model: "S 580", category: "luxury", pricePerDay: 250, seats: 5, transmission: "automatic", fuelType: "petrol", imageUrl: "/images/cars/mercedes-s.jpg", available: true, features: ["Chauffeur Ready", "Masazh", "Frigorifer", "Ekran 12.8\""], rating: 5.0, reviewCount: 64 },
  { id: 8, name: "Rolls-Royce Ghost", brand: "Rolls-Royce", model: "Ghost", category: "luxury", pricePerDay: 500, seats: 5, transmission: "automatic", fuelType: "petrol", imageUrl: "/images/cars/rolls-royce.jpg", available: true, features: ["Starlight Ceiling", "Masazh", "Champagne Cooler", "Bespoke Audio"], rating: 5.0, reviewCount: 31 },
  { id: 9, name: "Tesla Model 3", brand: "Tesla", model: "Model 3", category: "standard", pricePerDay: 80, seats: 5, transmission: "automatic", fuelType: "electric", imageUrl: "/images/cars/tesla-model3.jpg", available: true, features: ["Autopilot", "Karikues Falas", "15\" Ekran", "FSD Ready"], rating: 4.9, reviewCount: 212 },
  { id: 10, name: "Audi Q7", brand: "Audi", model: "Q7 55 TFSI", category: "suv", pricePerDay: 150, seats: 7, transmission: "automatic", fuelType: "petrol", imageUrl: "/images/cars/audi-q7.jpg", available: true, features: ["7 Vende", "Quattro AWD", "Matrix LED", "GPS"], rating: 4.8, reviewCount: 143 },
  { id: 11, name: "VW Transporter", brand: "Volkswagen", model: "Transporter T6", category: "van", pricePerDay: 95, seats: 9, transmission: "manual", fuelType: "diesel", imageUrl: "/images/cars/vw-transporter.jpg", available: true, features: ["9 Vende", "Klimë", "Bluetooth", "Ngarkim i Madh"], rating: 4.6, reviewCount: 78 },
  { id: 12, name: "SEAT Ibiza", brand: "SEAT", model: "Ibiza FR", category: "economy", pricePerDay: 32, seats: 5, transmission: "manual", fuelType: "petrol", imageUrl: "/images/cars/seat-ibiza.jpg", available: true, features: ["Klimë", "Bluetooth", "Sport Kit"], rating: 4.7, reviewCount: 115 },
];
